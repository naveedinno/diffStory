  ...
  <div class="layout">
    <section class="card scope-card" aria-label="Review scope">
      ...
      <div class="refpanel" data-panel="compare" id="comparePanel"${active === 'compare' ? '' : ' hidden'}>
        <label class="refrow"><span>Source <i>older</i></span><input id="cmpBase" data-picker="base" role="combobox" aria-autocomplete="list" aria-haspopup="listbox" aria-controls="refPicker" aria-expanded="false" placeholder="branch, tag, or commit" value="${esc(
          compareBaseValue,
        )}" autocomplete="off" spellcheck="false"></label>
        <span class="cmparrow" aria-hidden="true">→</span>
        <label class="refrow"><span>Target <i>newer</i></span><input id="cmpHead" data-picker="head" role="combobox" aria-autocomplete="list" aria-haspopup="listbox" aria-controls="refPicker" aria-expanded="false" placeholder="branch, tag, or commit" value="${esc(
          compareHeadValue,

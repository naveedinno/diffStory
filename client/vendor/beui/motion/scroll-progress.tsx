// Vendored from starc007/ui-components — components/motion/scroll-progress.tsx (MIT)
import {
  type MotionValue,
  motion,
  useReducedMotion,
...
// Upstream imports this from `./smooth-scroll`, which is a lenis wrapper we do
// not vendor (README modification 3). `../lib/use-smooth-scroll` is that file's
// native-scroll path, which is all this component reads.

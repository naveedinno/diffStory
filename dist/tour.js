...
function validateHotspots(t, errors) {
 ...
 */
function validateClaimedRanges(step, stepRange, where, errors, allowDeletionAnchor) {
    ...
    const anchored = valid.some((span) => isDeletionAnchor(span) || isDeletionAnchor(stepRange)

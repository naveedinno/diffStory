...
.ds-step[data-story-lens="focus"].is-story-active [data-diff-inner] .ds-diffbody>.ds-row:not(.is-story-camera),.ds-step[data-story-lens="focus"].is-story-active [data-diff-inner] .ds-diffbody>.ds-urow:not(.is-story-camera),.ds-step[data-story-lens="focus"].is-story-active [data-split-inner] .ds-diffbody>.ds-row:not(.is-story-camera),.ds-step[data-story-lens="focus"].is-story-active [data-split-inner] .ds-diffbody>.ds-urow:not(.is-story-camera){display:none}
.ds-step[data-story-lens="focus"].is-story-active [data-diff-inner] .ds-hunkgap,.ds-step[data-story-lens="focus"].is-story-active [data-split-inner] .ds-hunkgap{display:none}
...
.ds-focus-fold{display:flex;align-items:center;justify-content:center;gap:10px;min-height:30px;padding:4px 12px;border-top:1px solid var(--line-soft);border-bottom:1px solid var(--line-soft);background:var(--gutter);color:var(--dim);font-family:var(--sans);font-size:10.5px}
.ds-focus-fold button{border:0;background:transparent;color:var(--accent-blue);font:inherit;font-weight:750;cursor:pointer}.ds-focus-fold button:hover{text-decoration:underline}.ds-focus-fold button:focus-visible{outline:2px solid var(--accent-blue);outline-offset:2px}

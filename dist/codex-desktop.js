...
export function codexDesktopSocketPath() {
...
export function codexDesktopAvailable() {
    try {
...
export async function sendCodexDesktopTurn(threadId, prompt, options = {}) {
    ...
    try {
        ...
        if (response.resultType !== 'success')
            throw new Error(response.error || 'Codex Desktop rejected the message.');
        return {
            threadId,
